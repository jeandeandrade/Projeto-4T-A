<template>
  <nav
    class="w-[auto] h-[95px] flex-shrink-0 flex items-center justify-between px-12 navbar__styles"
  >
    <div class="flex items-center navbar__logo">
      <img
        src="../assets/images/logo.svg"
        alt="Logo"
        class="h-12 navbar__logo"
      />
    </div>
    ...
    <div
      class="flex items-center space-x-4 items__nav__signin__signup hidden lg:flex"
    >
      <!-- Mensagem de boas-vindas se o usuário estiver logado -->
      <span v-if="userLoggedIn" class="text-black font-semibold"
        >Bem-vindo(a), {{ userName }}!</span
      >
      <a
        v-if="!userLoggedIn"
        href="/login"
      ...
      <div v-if="userLoggedIn" class="flex items-center">
        <a
          href="/profile"
          class="text-blue-800 hover:text-blue-600 items__nav__signup"
          >Meu perfil&nbsp;&nbsp;</a
        >
        <div class="text__sign__signup">&nbsp;</div>
  ...
  <div v-if="showDropdown" class="lg:hidden dropdown__menu">
    <ul class="dropdown__items">
      ...
      <li class="items">
        <a href="#" class="hover:text-blue-600">SHOP BY CATEGORY</a>
      </li>
      ...
      <li class="items" v-if="!userLoggedIn">
        <a href="/registration" class="hover:text-blue-600">SIGN UP FOR FREE</a>
      </li>
      <li class="items" v-if="userLoggedIn">
        <a href="/profile" class="text-blue-800 hover:text-blue-600"
          >Meu perfil</a
        >
