<template>
  ...
  >
    <div class="flex gap-4 items-center mb-4">
      <h2 class="text-lg font-bold">Shop By Categories</h2>
  ...
  data() {
    return {
      categories: [
        ...
        { name: "Televisions", icon: "src/assets/icons/LED-TV.jpg" },
        { name: "PCs & Accessories", icon: "src/assets/icons/telefone.jpg" },
